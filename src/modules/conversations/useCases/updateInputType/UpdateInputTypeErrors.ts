...
export namespace UpdateInputTypeErrors {
  ...
  export class InputTypeNotExists extends Result<UseCaseError> {
    constructor(name: string) {
      super(false, {
        message: sprintf('Error. Input Type not found  Got: {0}', name),
      });
    }
  }
}
